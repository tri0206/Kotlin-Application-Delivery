...
class ClientProductSearchingListActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_client_product_searching_list)
    ...
    private fun getProducts() {
        productsProvider?.findByCategoryOrName(searchQuery!!)?.enqueue(object:
